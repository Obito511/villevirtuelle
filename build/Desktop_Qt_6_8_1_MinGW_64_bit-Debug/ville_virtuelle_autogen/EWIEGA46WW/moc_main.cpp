...
static constexpr auto qt_meta_stringdata_ZN4MainE = QtMocHelpers::stringData(
    "Main"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN4MainE[] = {
...
Q_CONSTINIT const QMetaObject Main::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN4MainE.offsetsAndSizes,
    qt_meta_data_ZN4MainE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN4MainE_t,
        // Q_OBJECT / Q_GADGET
...
void *Main::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN4MainE.stringdata0))
